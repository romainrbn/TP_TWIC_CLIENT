...
<body>
	...
	<div class="container mb-3 mt-3">
		<a href="/ESEO_TP_C/listeville/ajouter">
		...
		<table class="table table-striped table-bordered" id="myTable"
			...
			<thead>
				<tr>
					<th data-sortable="true" scope="col">Code commune INSEE</th>
			...
			<tbody>
				<c:forEach items="${listevilles}" var="ville">
					<tr>
						<th scope="row">${ville.getCodeCommuneINSEE()}</th>
						...
						<td><a
							href="/ESEO_TP_C/listeville/modifier?insee=${ville.getCodeCommuneINSEE()}"><button
									type="button" class="btn btn-primary">Modifier</button></a></td>
						<td><form method="post">
								<button name="delete" value="${ville.getCodeCommuneINSEE()}"
